...
function commandHandler(){
    ...
    switch ($command['command']){
        ...
        case 'version':{
            echo \Core\Component\Di::getInstance()->get(\Core\Component\Sys\SysConst::VERSION);
            echo "\n";
            break;
        }
        case 'help':
...
';
    ...
    echo 'easyswoole version   '.\Core\Component\Di::getInstance()->get(Core\Component\Sys\SysConst::VERSION)."\n";
    $server->run();
